...
<li><a href="http://en.wikipedia.org/wiki/Open-source_software">Wikipedia article on Open Source software</a></li>
...
<p><?php print s('To be written. In the meantime you can <a href="http://www.phplist.com/support">visit the support section on the phpList website</a>')?>.</p>
</div> 
