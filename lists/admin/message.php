...
if (empty($msgdata['sent'])) {
    $content .= '<tr><td colspan="2"><h4>' . s('Esta campa&ntilde;a ser&aacute; enviada a los suscriptres que son miembros de las siguientes listas') . ':</h4></td></tr>';
} else {
    $content .= '<tr><td colspan="2"><h4>' . $GLOBALS['I18N']->get('Esta campa&ntilde;a ser&aacute; enviada a los suscriptres que son miembros de las siguientes listas') . ':</h4></td></tr>';
}
...
<a name="resend"></a><p class="information"><?php echo s('Env&iacute;ar esta campa&ntilde;a a otra lista'); ?>:</p>
