...
var dlcalendar_oCalendarDefaults =
{
	...
	use_webdings : false,
	nav_images : "/control/images/dlcalendar_prevyear_white.gif,/control/images/dlcalendar_prevmonth_white.gif,/control/images/dlcalendar_nextmonth_white.gif,/control/images/dlcalendar_nextyear_white.gif",
...
[ '#dlcalendar_navigationRow',     'height:1.5em; width:100%; margin:0px; border:1px solid #000000; background-color:#5E885E; color:#ffffff; font-family:arial,helvetica,sans-serif; text-align:center;  cursor:default;' ],

[ 'td.dlcalendar_monthYearCell',   'padding-left:4px; padding-right:4px; padding-top:2px; padding-bottom:2px; cursor:default; font-size:12px; font-weight:bold;' ],
...
[ '#dlcalendar_headerRow',         'height:1.2em; text-align:center; vertical-align:middle; color:#ffffff; background-color:#BCD2BC; font-family:arial,helvetica,sans-serif; cursor:default;' ],
[ 'th.dlcalendar_headerRowCell',   'width:1em; padding:2px; font-size: 11px; text-align:center; color:#000000' ],

[ 'tr.dlcalendar_dateRow',         'height:1.2em; text-align:center; vertical-align:middle;' ],

[ 'td.dlcalendar_dayRegular',      'font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; width:1em; padding:2px; border:1px solid #ffffff; color:#7e7e7e; background-color:#ffffff; cursor:pointer' ],
[ 'td.dlcalendar_dayWeekend',      'font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; width:1em; padding:2px; border:1px solid #ffffff; color:#990000; background-color:#ffffff; cursor:pointer' ],
[ 'td.dlcalendar_daySelected',     'font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; width:1em; padding:2px; border:1px solid #000000; color:#000000; background-color:#E0E0E0; cursor:default' ],
[ 'td.dlcalendar_dayOtherMonth',   'font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; width:1em; padding:2px; border:1px solid #ffffff; color:#ffffff; background-color:#ffffff; cursor:default' ],
[ 'td.dlcalendar_dayDisabled',     'font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; width:1em; padding:2px; border:1px solid #ffffff; color:#cccccc; background-color:#ffffff; cursor:default' ]
];
